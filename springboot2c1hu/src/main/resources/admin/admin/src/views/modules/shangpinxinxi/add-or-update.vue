<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供货地址" prop="gonghuodizhi">
          <el-input v-model="ruleForm.gonghuodizhi" 
              placeholder="供货地址" clearable  :readonly="ro.gonghuodizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供货地址" prop="gonghuodizhi">
              <el-input v-model="ruleForm.gonghuodizhi" 
                placeholder="供货地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出厂日期" prop="chuchangriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuchangriqi" label="出厂日期" prop="chuchangriqi">
              <el-input v-model="ruleForm.chuchangriqi" 
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='gonghuodizhi'){
            this.ruleForm.gonghuodizhi = obj[o];
	    this.ro.gonghuodizhi = true;
            continue;
          }
          if(o=='chuchangriqi'){
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springboot2c1hu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
